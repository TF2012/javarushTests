...
public class OurUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    protected String getFormattedStringForFirstThread(Thread t, Throwable e, String stringFormat) {
        return String.format(stringFormat, t.getName(), e.getClass().getSimpleName(), e.getCause());
    }

    /*
    1# : StringForFirstThreadTooShortException : java.lang.StringIndexOutOfBoundsException:
